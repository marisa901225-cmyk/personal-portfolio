...
개인 자산, 뉴스, 알림, 리포트, 실험용 자동매매를 한 저장소에서 운영하는 홈서버 프로젝트입니다.
...
API_TOKEN=...
JWT_SECRET_KEY=...
# Naver Login (NAVER Developers)
NAVER_CLIENT_ID=...
NAVER_CLIENT_SECRET=...
# Naver News Search (NAVER API HUB)
NAVER_API_CLIENT_ID=...
NAVER_API_CLIENT_SECRET=...
NAVER_API=...
# 전체 컨테이너 공유 안전 예산 (공급자 한도보다 여유 있게 설정)
NAVER_API_DAILY_LIMIT=24000
NAVER_API_MONTHLY_LIMIT=744000
TELEGRAM_BOT_TOKEN=...
TELEGRAM_CHAT_ID=...
KIS_MY_APP=...
KIS_MY_SEC=...
