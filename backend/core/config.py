...
class Settings(BaseSettings):
    ...
    kis_my_app2: Optional[str] = Field(default=None, validation_alias="KIS_MY_APP2")
    kis_my_sec2: Optional[str] = Field(default=None, validation_alias="KIS_MY_SEC2")
    kis_my_acct_stock2: Optional[str] = Field(default=None, validation_alias="KIS_MY_ACCT_STOCK2")
    kis_my_prod2: Optional[str] = Field(default=None, validation_alias="KIS_MY_PROD2")
