...
class ImageGenerationError(RuntimeError):
    """Raised when AI planning or ComfyUI generation fails."""
...
def _tool_spec_from_arguments(arguments: dict[str, Any], request: ComfyUIImageGenerationRequest) -> _ToolSpec:
