...
async def test_random_messages():
    ...
    from backend.services.alarm.random_categories import (
        load_recent_categories,
        pick_keywords_for_constraints,
        save_recent_category,
        save_last_random_topic_sent_at,
    )
    from backend.services.alarm.llm_refiner import clean_meta_headers, generate_with_main_llm_async
    ...
    try:
        ...
        if final_result:
            ...
            save_last_random_topic_sent_at(datetime.now())
